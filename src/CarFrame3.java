...
//public class CarFrame3 extends Frame implements WindowListener {
public class CarFrame3 extends Frame {
		
	public CarFrame3() {
		MyListener listener = new MyListener();
		//addWindowListener(new MyWindowListener());	// 1번 방법 이너 클래스
		//addWindowListener(new MyWindowAdapter());		// 2번 방법 이너 어댑터 클래스
		//addWindowListener(this);						// 3번 방법 클래스가 직접 구현
